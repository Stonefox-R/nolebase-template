## 驱动级别
### 关于cuda版本问题
![[../imgs/Pasted image 20240912142352.png]]
...
![[../imgs/Pasted image 20240923143211.png]]
...
![[../imgs/Pasted image 20240923144120.png]]
...
![[../imgs/Pasted image 20240915190354.png]]
在pypi官网能够查询到其最新版本为0.18，但是pip指令就是无法安装
![[../imgs/Pasted image 20240915190446.png]]
主要原因是系统不满足库的使用要求，可以在
![[../imgs/Pasted image 20240915190534.png]]
查看到版本要求！！！
...
For human, position imformation like (0,0) or (3,7) is clear and elegant. On the contrarary , machine can't understand what is cordinate main.So we need embedder to transform the  compact info into a complex situation.
```python
B = x["pos"].shape[0]                            
